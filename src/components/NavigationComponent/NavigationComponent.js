...
import { faArrowRightFromBracket, faUser, faArrowRightToBracket, faHouse, faImages, faUserGroup, faEnvelope, faMessage } from '@fortawesome/free-solid-svg-icons';
    ...
    <>
      ...
      <nav className={`header__main-nav nav ${menuOpen ? 'open' : ''}`}>
        <ul className="main-nav__ul ul">
          ...
          <li className="main-nav__li li">
            <Link className="main-nav__link link" onClick={toggleMenu} to="/gallery">
          ...
          <li className="main-nav__li li">
            <Link className="main-nav__link link" onClick={toggleMenu} to="/messages">
