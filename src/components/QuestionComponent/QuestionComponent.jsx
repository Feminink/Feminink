  ...
  if (isFinished && score === 0) {
    return (
      <div className={"points" + score}>
        {" "}
        <h2 className="points__h2">
          {" "}
          Has acertado {score} de {info.quiz.length} quizá para la próxima!{" "}
        </h2>
    ...
    return (
      <div className={"points" + score}>
        ...
        <h2 className="points__h2">
          {" "}
          Has acertado {score} de {info.quiz.length}
        </h2>
    ...
    return (
      <div className={"points" + score}>
        ...
        <button className="button__quiz" onClick={randomCode}>
          YOU GOT IT{" "}
        </button>
        <div>
          {" "}
          <h1 className="points__win">{code}</h1>
    ...
    <div className="div__question__wrapper">
      ...
      <div className="questions">
        <div className="questions__numbers">
          <h3 className="questions__numbers__h3">
            {" "}
            Question {questCurrent + 1} of {Questions.length}
          </h3>
        </div>
        <div className="left__side__number__question__title">
          <h2 className="number__question">
