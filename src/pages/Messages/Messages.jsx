      ...
      <>
        ...
        <section className="section__messages">
          <div className="wrapper">
            ...
            <button className="load" onClick={loadMoreMessages}>
